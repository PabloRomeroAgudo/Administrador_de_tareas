        ...
        setContent {
            AdministradorDeTareasTheme {
                ...
                Surface(
                    ...
                    Administrador(stringResource(R.string.firstMessage), stringResource(R.string.secondMessage))
                }
            }
        }
    }
...
@Composable
fun Administrador(firstMessage: String, secondMessage: String, modifier: Modifier = Modifier) {
